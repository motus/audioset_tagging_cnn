...
python3 utils/dataset.py download_wavs --csv_path=$WORKSPACE"/metadata/eval_segments.csv" --audios_dir=$WORKSPACE"/audios/eval_segments"
...
time python3 pytorch/main.py train --workspace=$WORKSPACE --data_type='balanced_train' --sample_rate=16000 --window_size=512 --hop_size=160 --mel_bins=64 --fmin=50 --fmax=8000 --model_type='MobileNetV1' --loss_type='clip_bce' --balanced='none' --augmentation='none' --batch_size=32 --learning_rate=1e-3 --resume_iteration=0 --early_stop=10 --evaluation_rate=1 --checkpoint_rate=1